...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if ($conn->query($sql) === TRUE) {
            echo "<script>alert('Patient added successfully!'); window.location.href='add_patient.php';</script>";
        } else {
...
if (isset($_GET['delete'])) {
    ...
    if ($conn->query($sql) === TRUE) {
        echo "<script>alert('Patient deleted successfully!'); window.location.href='add_patient.php';</script>";
    } else {
...
<script>
    ...
    function filterTable() {
        ...
        tableRows.forEach(row => {
            ...
            const appointmentDate = row.getAttribute('data-appointment');
            ...
            if (appointment !== "all") {
                if (appointment === "upcoming" && appointmentDate < today) show = false;
                if (appointment === "past" && appointmentDate >= today) show = false;
            }
